...
hist(rice_subset$AirTempF, main = "Histogram of AirTempF", xlab = "Air Temperature (F)", col = "lightblue", border = "black")
hist(rice_subset$BP_HG, main = "Histogram of BP_HG", xlab = "Barometric Pressure (mm Hg)", col = "lightgreen", border = "black")

# Set up a 1x2 plot grid again for Q-Q plots
par(mfrow = c(1, 2))

# Q-Q plot for AirTempF
qqnorm(rice_subset$AirTempF, main = "Q-Q Plot of AirTempF")
qqline(rice_subset$AirTempF, col = "red")

# Q-Q plot for BP_HG
qqnorm(rice_subset$BP_HG, main = "Q-Q Plot of BP_HG")
qqline(rice_subset$BP_HG, col = "red")
