...
# Slightly more, magnitude = 0.01891
```
...
# Not Quite...Print: Debugging, inspecting object contents, and general output.
# Cat: Concatenating strings, creating custom messages, and generating formatted output.
```
...
```{r}
properName <- paste(person, cool, sep = ", ")
properName
```
